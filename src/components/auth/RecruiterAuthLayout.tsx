...
import { RecruiterLeftPanel } from "@/components/auth/RecruiterLeftPanel";

type RecruiterAuthLayoutProps = {
  children: ReactNode;
};

export function RecruiterAuthLayout({ children }: RecruiterAuthLayoutProps) {
  return (
